...
import { imagePlaceholderClass, interactiveCardClass } from "./page-helpers";
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ${campaigns
          ...
          <article class="${interactiveCardClass} h-full overflow-hidden">
            ...
            ${campaign.image ? `<img src="${escapeAttribute(buildSiteStorageUrl(campaign.image))}" alt="${escapeHtml(campaign.name)}" class="h-48 w-full object-contain" />` : `<div class="${imagePlaceholderClass}">Sin imagen</div>`}
